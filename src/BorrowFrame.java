...
public class BorrowFrame extends FrameTemplate implements ActionListener, FocusListener, KeyListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource() == submitBtn)
        {
            ...
            {
                Book selectedBook = Book.getBook(shelves.get(shelfDropDown.getSelectedIndex()), titleDropDown, books);

                user.borrowingData.add(new BorrowingData(selectedBook,
        ...
        {
            if(shelfDropDown.getSelectedItem() != null)
            {
                setTitleDropDown();
            }
        }
    ...
    private void setTitleDropDown()
    {
        ...
        Book.getTitles(shelves.get(shelfDropDown.getSelectedIndex()), titleDropDown, books);

        if(titleDropDown.getItemCount() == 0)
        {
            JOptionPane.showMessageDialog(this, "No books on shelf " + shelfDropDown.getSelectedItem() + " is available!\n Please choose another shelf!");
        }
